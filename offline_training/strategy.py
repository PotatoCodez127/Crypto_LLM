...
def get_signals(df):
    ...
    # More adaptive volatility filter: allow moderate to high volatility, avoid extremes
    vol_strong = (vol_ratio > 1.2) & (vol_ratio < 3.0)  # volatility 20% above median but not extreme

...
def get_signals(df):
    ...
    # Additional percentile filter for CVD extreme
    ...
    # Tougher thresholds for both normalized metrics and raw percentile
    ...
    for i in range(len(df)):
        ...
        if vol_med > 0:
            # Tighter adaptive range
            vol_ratio_local = vol / vol_med
            # Sigmoid scaling between 1.5 and 3.0

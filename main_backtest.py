...
class QuantitativeEvaluator:
    ...
    def _load_data(self):
        ...
        if self.data_path and os.path.exists(self.data_path):
            ...
            default_paths = ["data/btc_1h_1y.csv", "../data/btc_1h_1y.csv", "./data/btc_1h_1y.csv"]
    ...
    def calculate_metrics(self, returns, prices, signals):
        ...
        sortino = (
            np.sqrt(365 * 24) * excess_returns.mean() / downside_std if downside_std > 0 else 0
        )
    ...
    def evaluate_strategy_with_params(
        self, strategy_func, params=None, train_days=180, test_days=30
    ):
        """
        ...
        metrics = self.calculate_metrics(
            all_returns, self.data.loc[all_returns.index, "close"], all_signals
        )
...
if __name__ == "__main__":
    ...
    metrics = evaluator.evaluate_strategy_with_params(
        get_signals, params, train_days=180, test_days=30
    )

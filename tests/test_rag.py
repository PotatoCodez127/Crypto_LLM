...
from strategy_trainer.rag_memory import StrategyMemoryBank
...
def run_rag_test():
    ...
    memory_bank.log_trial(
        "d4e5f", "Used CVD and Open Interest to filter out sideways chop", 0.12, "keep"
    )
    memory_bank.log_trial(
        "g7h8i", "Removed RSI and added Bollinger Bands mean reversion", -0.15, "discard"
    )

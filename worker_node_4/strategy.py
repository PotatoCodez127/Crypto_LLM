...
def generate_signals(df):
    ...
    # Use all V2 features for maximum pattern detection
    features = [
        'open',
        'high',
        'low',
    ...
    model = xgb.XGBClassifier(
        max_depth=10,           # Drastically increased for complex pattern detection
        learning_rate=0.1,      # Moderate learning rate for aggressive learning
        n_estimators=100,       # Keep number of trees moderate
        random_state=42,

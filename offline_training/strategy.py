...
def get_signals(df):
    ...
    df['raw_signal'] = 0
    # Relaxed thresholds for more signals, volatility filter less strict
    ...
    for i in range(len(df)):
        ...
        if vol_med > 0:
            # Less aggressive ATR multiplier to allow more room
            vol_ratio = vol / vol_med
            # Linear scaling between 1.2 and 3.0 based on vol_ratio
        ...
        if position == 0:
            ...
            # Slightly looser max loss protection

...
def get_signals(df):
    ...
    - Long when MACD histogram > 0.0003, RSI > 60, close > SMA20, and SMA20 > SMA50
    - Short when MACD histogram < -0.0003, RSI < 40, close < SMA20, and SMA20 < SMA50
    - Stop-loss with dynamic ATR multiplier (1.2-2.0) based on recent volatility.
    - Take-profit at 2*ATR multiplier.
    No cooldown period, tighter stops with profit target.
    """
    # 1. Calculate MACD
    ...
    # Adjusted RSI thresholds: long >60, short <40
    ...
    # No cooldown period to capture more opportunities
